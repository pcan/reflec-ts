...
declare namespace ts {
    ...
    type StatementsBlock = Block | SourceFile | ModuleBlock;
    type TypeDeclaration = DeclarationStatement;
}
declare namespace ts.reflection {
    const reflectionModuleName = "Reflection";
    const reflectionLocalVariableName = "$reflection";
    const registerPackageFunctionName = "registerPackage";
    const interfaceForNameFunctionName = "interfaceForName";
    const registerClassFunctionName = "registerClass";
    const registerClassDecoratorName = "RegisterClass";
    const classTypeName = "Class";
    const interfaceTypeName = "Interface";
    const libsField = "$libs";
    const localTypeVar = "_l";
    const tempTypeVar = "_t";
    ...
    function getSafeIdentifierName(name: string): string;
    interface IntrinsicTypeDescriptor {
        varName: string;
        definition: string;
    }
    ...
    const intrinsicTypeFlagsMask: number;
    const allTypeFlagsMask: number;
    ...
    function addReflectionInfo(type: Type, typeCounter: Counter, typeDeclaration?: Statement): void;
    interface Counter {
        getValue(): number;
        increment(): number;
    }
    function createCounter(initValue?: number): Counter;
    class Writer {
        private newLine;
        private output;
        private indent;
        ...
        write(s: string): this;
        writeAtBeginning(s: string): this;
        writeLine(): this;
        getText(): string;
        increaseIndent(): this;
        decreaseIndent(): this;
        writeObjectStart(skipNewLine?: boolean): this;
        writeObjectEnd(skipNewLine?: boolean): this;
        writeArrayStart(skipNewLine?: boolean): this;
        writeArrayEnd(skipNewLine?: boolean): this;
    ...
    module debug {
        function info(message: any, ...strArray: any[]): void;
        function warn(message: any, ...strArray: any[]): void;
    }
    const contentHeader: string;
    const contentFooter: string;
}
declare namespace ts.reflection {
    function writeType(type: Type, checker: TypeChecker, typeCounter: Counter, writer: Writer): Type[];
}
declare namespace ts.reflection {
    class SourceASTBuilder {
        private sourceFile;
        ...
        commit(statement?: Statement, parent?: StatementsBlock, index?: number): void;
        private pos();
    }
    ...
    function getDeclarationName(decl: DeclarationStatement): string;
}
declare namespace ts.reflection {
    function injectReflectionHooks2(sourceFile: SourceFile, useDecorators: boolean): void;
}
declare namespace ts.reflection {
    function initConfig(compilerHost: CompilerHost, compilerOptions: CompilerOptions): void;
    function addReflectionToAST(sourceFile: SourceFile): void;
    function emitReflectionModule(resolver: EmitResolver, host: EmitHost, program: Program, sourceFile: SourceFile): void;
}
declare namespace ts {
...
declare namespace ts {
    ...
    function createSourceFile(fileName: string, sourceText: string, compilerOptions: CompilerOptions, setParentNodes?: boolean, scriptKind?: ScriptKind): SourceFile;
