...
(function (ts) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind[SyntaxKind["MetaProperty"] = 202] = "MetaProperty";
        SyntaxKind[SyntaxKind["TemplateSpan"] = 203] = "TemplateSpan";
        SyntaxKind[SyntaxKind["SemicolonClassElement"] = 204] = "SemicolonClassElement";
        SyntaxKind[SyntaxKind["Block"] = 205] = "Block";
        SyntaxKind[SyntaxKind["VariableStatement"] = 206] = "VariableStatement";
        SyntaxKind[SyntaxKind["EmptyStatement"] = 207] = "EmptyStatement";
        SyntaxKind[SyntaxKind["ExpressionStatement"] = 208] = "ExpressionStatement";
        SyntaxKind[SyntaxKind["IfStatement"] = 209] = "IfStatement";
        SyntaxKind[SyntaxKind["DoStatement"] = 210] = "DoStatement";
        SyntaxKind[SyntaxKind["WhileStatement"] = 211] = "WhileStatement";
        SyntaxKind[SyntaxKind["ForStatement"] = 212] = "ForStatement";
        SyntaxKind[SyntaxKind["ForInStatement"] = 213] = "ForInStatement";
        SyntaxKind[SyntaxKind["ForOfStatement"] = 214] = "ForOfStatement";
        SyntaxKind[SyntaxKind["ContinueStatement"] = 215] = "ContinueStatement";
        SyntaxKind[SyntaxKind["BreakStatement"] = 216] = "BreakStatement";
        SyntaxKind[SyntaxKind["ReturnStatement"] = 217] = "ReturnStatement";
        SyntaxKind[SyntaxKind["WithStatement"] = 218] = "WithStatement";
        SyntaxKind[SyntaxKind["SwitchStatement"] = 219] = "SwitchStatement";
        SyntaxKind[SyntaxKind["LabeledStatement"] = 220] = "LabeledStatement";
        SyntaxKind[SyntaxKind["ThrowStatement"] = 221] = "ThrowStatement";
        SyntaxKind[SyntaxKind["TryStatement"] = 222] = "TryStatement";
        SyntaxKind[SyntaxKind["DebuggerStatement"] = 223] = "DebuggerStatement";
        SyntaxKind[SyntaxKind["VariableDeclaration"] = 224] = "VariableDeclaration";
        SyntaxKind[SyntaxKind["VariableDeclarationList"] = 225] = "VariableDeclarationList";
        SyntaxKind[SyntaxKind["FunctionDeclaration"] = 226] = "FunctionDeclaration";
        SyntaxKind[SyntaxKind["ClassDeclaration"] = 227] = "ClassDeclaration";
        ...
        SyntaxKind[SyntaxKind["EnumDeclaration"] = 230] = "EnumDeclaration";
        ...
        SyntaxKind[SyntaxKind["NamespaceExportDeclaration"] = 234] = "NamespaceExportDeclaration";
        SyntaxKind[SyntaxKind["ImportEqualsDeclaration"] = 235] = "ImportEqualsDeclaration";
        SyntaxKind[SyntaxKind["ImportDeclaration"] = 236] = "ImportDeclaration";
        SyntaxKind[SyntaxKind["ImportClause"] = 237] = "ImportClause";
        SyntaxKind[SyntaxKind["NamespaceImport"] = 238] = "NamespaceImport";
        SyntaxKind[SyntaxKind["NamedImports"] = 239] = "NamedImports";
        SyntaxKind[SyntaxKind["ImportSpecifier"] = 240] = "ImportSpecifier";
        SyntaxKind[SyntaxKind["ExportAssignment"] = 241] = "ExportAssignment";
        SyntaxKind[SyntaxKind["ExportDeclaration"] = 242] = "ExportDeclaration";
        SyntaxKind[SyntaxKind["NamedExports"] = 243] = "NamedExports";
        ...
        SyntaxKind[SyntaxKind["JsxAttribute"] = 251] = "JsxAttribute";
        SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 252] = "JsxSpreadAttribute";
        SyntaxKind[SyntaxKind["JsxExpression"] = 253] = "JsxExpression";
        SyntaxKind[SyntaxKind["CaseClause"] = 254] = "CaseClause";
        SyntaxKind[SyntaxKind["DefaultClause"] = 255] = "DefaultClause";
        SyntaxKind[SyntaxKind["HeritageClause"] = 256] = "HeritageClause";
        SyntaxKind[SyntaxKind["CatchClause"] = 257] = "CatchClause";
        SyntaxKind[SyntaxKind["PropertyAssignment"] = 258] = "PropertyAssignment";
        SyntaxKind[SyntaxKind["ShorthandPropertyAssignment"] = 259] = "ShorthandPropertyAssignment";
        SyntaxKind[SyntaxKind["SpreadAssignment"] = 260] = "SpreadAssignment";
        SyntaxKind[SyntaxKind["EnumMember"] = 261] = "EnumMember";
        SyntaxKind[SyntaxKind["SourceFile"] = 262] = "SourceFile";
        SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 263] = "JSDocTypeExpression";
        SyntaxKind[SyntaxKind["JSDocAllType"] = 264] = "JSDocAllType";
        SyntaxKind[SyntaxKind["JSDocUnknownType"] = 265] = "JSDocUnknownType";
        SyntaxKind[SyntaxKind["JSDocArrayType"] = 266] = "JSDocArrayType";
        SyntaxKind[SyntaxKind["JSDocUnionType"] = 267] = "JSDocUnionType";
        SyntaxKind[SyntaxKind["JSDocTupleType"] = 268] = "JSDocTupleType";
        SyntaxKind[SyntaxKind["JSDocNullableType"] = 269] = "JSDocNullableType";
        SyntaxKind[SyntaxKind["JSDocNonNullableType"] = 270] = "JSDocNonNullableType";
        SyntaxKind[SyntaxKind["JSDocRecordType"] = 271] = "JSDocRecordType";
        SyntaxKind[SyntaxKind["JSDocRecordMember"] = 272] = "JSDocRecordMember";
        SyntaxKind[SyntaxKind["JSDocTypeReference"] = 273] = "JSDocTypeReference";
        SyntaxKind[SyntaxKind["JSDocOptionalType"] = 274] = "JSDocOptionalType";
        SyntaxKind[SyntaxKind["JSDocFunctionType"] = 275] = "JSDocFunctionType";
        SyntaxKind[SyntaxKind["JSDocVariadicType"] = 276] = "JSDocVariadicType";
        SyntaxKind[SyntaxKind["JSDocConstructorType"] = 277] = "JSDocConstructorType";
        SyntaxKind[SyntaxKind["JSDocThisType"] = 278] = "JSDocThisType";
        SyntaxKind[SyntaxKind["JSDocComment"] = 279] = "JSDocComment";
        SyntaxKind[SyntaxKind["JSDocTag"] = 280] = "JSDocTag";
        SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 281] = "JSDocAugmentsTag";
        ...
        SyntaxKind[SyntaxKind["JSDocLiteralType"] = 289] = "JSDocLiteralType";
        SyntaxKind[SyntaxKind["JSDocNullKeyword"] = 290] = "JSDocNullKeyword";
        SyntaxKind[SyntaxKind["JSDocUndefinedKeyword"] = 291] = "JSDocUndefinedKeyword";
        SyntaxKind[SyntaxKind["JSDocNeverKeyword"] = 292] = "JSDocNeverKeyword";
        ...
        SyntaxKind[SyntaxKind["FirstJSDocNode"] = 263] = "FirstJSDocNode";
